...
if __name__ == '__main__':
    ...
    dataset = make_dataset(opt.dataset, conditional=opt.conditional,rain=True)
    ...
    if args.generator_file is not None:
        print("Loading generator from: %s", args.generator_file)
    ...
    if args.discriminator_file is not None:
        print("Loading discriminator from: %s", args.discriminator_file)
        style_gan.dis.load_state_dict(torch.load(args.discriminator_file))

    if args.gen_shadow_file is not None and opt.use_ema:
        print("Loading shadow generator from: %s", args.gen_shadow_file)
    ...
    if args.gen_optim_file is not None:
        print("Loading generator optimizer from: %s", args.gen_optim_file)
        style_gan.gen_optim.load_state_dict(torch.load(args.gen_optim_file))

    if args.dis_optim_file is not None:
        print("Loading discriminator optimizer from: %s", args.dis_optim_file)
